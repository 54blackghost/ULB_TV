...

  {
    ...
    answerDetails: [

      {
        ...
        id: 101, // Changed ID to be more unique
        ...
        content: "Vous pouvez utiliser la méthode `withPivot()` sur votre définition de relation Eloquent pour spécifier les colonnes de la table pivot que vous souhaitez récupérer.",
        ...
        replies: [

          {
            ...
            id: 201, // ID for the reply

            author: {

              name: "Jean Dupont", // Original poster replies

              avatar: "https://images.pexels.com/photos/1674666/pexels-photo-1674666.jpeg?auto=compress&cs=tinysrgb&w=100"

            },

            content: "Merci Alice, ça fonctionne parfaitement ! C'est exactement ce que je cherchais.",

            postedAt: "Il y a 30 minutes"
...

      {
        ...
        content: "N'oubliez pas d'accéder aux données du pivot via l'attribut `pivot` sur le modèle, comme ceci : `$user->roles()->first()->pivot->votre_colonne;`",

        postedAt: "Il y a 45 minutes",
...

      {
        ...
        content: "Une autre approche serait de créer un modèle pour la table pivot elle-même si elle contient beaucoup de logique.",

        postedAt: "Il y a 15 minutes",
