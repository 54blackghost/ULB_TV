...
export default function AboutUs() {
    return (
        <>
            ...
            `}</style>
             {/* Include Navbar for consistent layout */}
            <section className="flex flex-col md:flex-row items-center justify-center gap-10 max-md:px-4 py-20 bg-gray-900 text-white min-h-screen"> {/* Added py-20, bg and text colors for contrast */}
                ...
                <div className="text-sm text-gray-300 max-w-lg"> {/* Changed text color for contrast */}
                    <h1 className="text-xl uppercase font-semibold text-white">What we do?</h1> {/* Changed text color for contrast */}
