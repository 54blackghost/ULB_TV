        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between mb-12">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h2 className="text-3xl font-bold text-gray-700">Articles récents</h2>
                <p className="text-gray-500 mt-1">Découvrez les derniers articles de notre communauté</p>
              </div>
            </div>
      ...
      <section className="py-16 bg-gradient-laravel">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-white/90 mb-8 leading-relaxed">
            ...
            font évoluer l'écosystème PHP et Laravel au Cameroun.
          </p>
